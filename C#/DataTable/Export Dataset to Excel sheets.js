//http://stackoverflow.com/questions/10637918/how-to-use-oledb-to-create-excel-database
  /// <summary>
  ...
  public void Save(string excelFile) {
    using (ExcelWriter writer = new ExcelWriter(excelFile)) {
      ...
      foreach (DataTable table in Dataset.Tables) {
        writer.WriteStartWorksheet(string.Format("{0}", "sheetname")); // Write the worksheet contents
