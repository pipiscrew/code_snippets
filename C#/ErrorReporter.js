...
public sealed class ErrorReporter : Form
{
    ...
    private void btnGen_Click(object sender, EventArgs e)
    {
        ...
        {
            MessageBox.Show("The error report could not be created.", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Hand);
            return;
        }
        else 
            MessageBox.Show("Error report successfully dumped at 'Errors' dir", Application.ProductName, MessageBoxButtons.OK, MessageBoxIcon.Information);
    }
    ...
    private void RueErrorReporter_FormClosed(object sender, FormClosedEventArgs e)
    {
        if (this.chkRestart.Checked)
        {
            Application.Restart();
    ...
    private void InitializeComponent()
    {
        ...
        this.btnClose.Location = new Point(307, 343);
        ...
        this.btnGen.Location = new Point(175, 343);
        this.btnGen.Name = "btnGen";
        this.btnGen.Size = new Size(125, 23);
        this.btnGen.TabIndex = 3;
        this.btnGen.Text = "&Generate Error Report";
        ...
        base.FormClosed += new FormClosedEventHandler(this.RueErrorReporter_FormClosed);
