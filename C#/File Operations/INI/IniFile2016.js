...
//always use application.startuppath on console  AppDomain.CurrentDomain.BaseDirectory +  "\\Settings.ini"
...
namespace MyProg
{
    class IniFile   // revision 11
    {
        ...
        statp extern long WritePrivateProfileString(string Section, string Key, string Value, string FilePath);
