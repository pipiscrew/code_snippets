            ...
            Do While sr.Peek() >= 0
                ...
                Else
                    ...
                    If Mid(line, 1, 2) = "@=" Then
                        ...
                        Result.Add(New RegistryList(strMainKey, VAR, IdentifyValueType(VARvalue.ToLower), VARvalue))
...
'**** hot to use
    ...
    Private Sub Additem2(ByVal regParent As String, ByVal regVar As String, ByVal regVALType As String, ByVal regVAL As String)

        Dim oitem As ListViewItem = New ListViewItem()

        Dim osItem As ListViewItem.ListViewSubItem

        oitem.Text = regParent
        '        oitem.Tag = rsKEY
