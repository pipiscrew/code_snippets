                    ...
                    $.ajax({
                        ...
                        success : function(msg) {
                            if (msg == "refresh")
                                ...
                                alert("Record is not saved"); //warn user
                        },
                        error : function() {
                            alert("failure");
                        }
...
//WARNING : the only way to get response from PHP call is to :
//http://stackoverflow.com/questions/13366204/ajax-jquery-php-return-value
-set the -- dataType : 'json'
-to php file return a json -- echo json_encode("refresh");
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form id="formADDNEW" role="form" method="post" action="income_new.php">
